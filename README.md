...
Random Forest - Mean Absolute Error = 0.496, Root Mean Squared Error = 0.704, R-Squared Value = -0.990
...
- However, the negative R² values for both models suggest that there may be an issue with the model fitting to be improved.
